...
# STEP: BASE FILE NAME
    ...
    # NEXT STEP
        ...
        await event.reply("👤 Now send contact base name\nExample: spidy")
        return
...
# CONTACT NAME + SPLIT
    if state == "WAIT_SPLIT_CONTACT_NAME":
        ...
        contact_base, contact_start =     split_name_number(text)
 
        src = user_data[uid].get("split_file")
...
# ---------- CONVERT (ALL TYPES / ALL FILES) ----------
    ...
    if data == "split_custom_yes":
        ...
        user_data[uid]["split_file"] = user_files[uid][0]   # 🔥 ADD THIS
