...
async def buttons(event):
    ...
    if data == "split":
        ...
        user_files[uid] = []
        await event.edit("📂 Please send your VCF file to split", buttons=None)
        return
...
async def done(event):
    ...
    # ===== EDIT FLOW =====
    if user_state.get(uid) == "WAIT_EDIT_FILE":
